...
int main()
{
    ...
    // Test Baca/tulis
    printf("Masukkan nilai pada absis dan ordinat dari titik P1: \n");
    BacaPOINT(&P);
    printf("Titik yang dibaca adalah ");
    TulisPOINT(P);
    printf("\n");
    // Test keberadaan dari titik P
    if (IsOrigin(P))
    {
    ...
    scanf("%f", &dx);
    printf("jika P1 digeser sejajar sumbu y sebesar: ");
    scanf("%f", &dy);
